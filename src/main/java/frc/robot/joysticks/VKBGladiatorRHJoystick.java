...
/**
 * Wrapper for the VKB Gladiator NXT EVO Space Combat Edition (Right-Hand)
 * using WPILib's CommandJoystick-style API with overloaded functions.
 */
public class VKBGladiatorRHJoystick extends CommandJoystick {
     ...
     */
    public VKBGladiatorRHJoystick(int port) {
        super(port);
    }
