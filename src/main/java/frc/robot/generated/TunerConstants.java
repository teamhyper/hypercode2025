...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.18067).withKI(0).withKD(0)
        .withKS(0.20941).withKV(0.12001).withKA(0.0134320);
    ...
    public static final CANBus kCANBus = new CANBus("hyperbus", "./logs/example.hoot");

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.921687);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.322021484375);
